...
/**
 * Get the tags by the wordlist auto
 *
 * @param string description of a blog description
 * @return a string of tags
 */
function blog_get_tags($ch){
    if(strlen($ch) == 0) return "No Tags~";
    $kind = array(50);
    $words = array(50 => 1000);
    $fw = fopen(dirname(__FILE__)."/words.txt","r");
    if($fw == NULL){
